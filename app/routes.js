...
const watsonTokenManager = new watson.AuthorizationV1(watsonSpeech.getCredentials());
...
module.exports = (app, passport) => {
  ...
  app.post('/joinQueue', (req, res) => {
    ...
    twiml.say({ voice: 'Polly.Brian' }, 'Welcome to Phony! We\'ll be putting you through to an operator shortly.');
    twiml.enqueue({
        waitUrl: '/music'
    }, 'support');
